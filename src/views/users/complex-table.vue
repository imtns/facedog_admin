        ...
        <el-table :key="tableKey"
            ...
            <el-table-column label="UID"
                ...
                <template slot-scope="scope">
                    <router-link :to="'/users/'+scope.row._id"
                                 class="link-type">
            ...
            <el-table-column label="图片"
                ...
                <template slot-scope="scope">
                    <el-button type="text"
                               @click="showImage(scope.row.avatar)">查看头像</el-button>
                </template>
            </el-table-column>
            <el-table-column label="设置评级"
                             width="140px"
                             align="center">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.level"
                               placeholder="设置评级"
                               @change="levelChange(scope.row.level,scope.row._id)">
            ...
            <el-table-column label="真人认证"
                             width="110px"
                             align="center">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.video_audit"
                               value-key="key"
                               placeholder="设置评级"
                               @change="auditChange(scope.row.video_audit,scope.row._id)">
        ...
        <el-dialog v-el-drag-dialog
            ...
            <div class="text-center"
                ...
                <el-button type="danger"
                           @click="dialogTooltip=false"
                           style="margin-right:50px">取消</el-button>
                <el-button type="primary"
                           @click="deleteUser()">确定</el-button>
            </div>
        </el-dialog>
        <el-dialog v-el-drag-dialog
                   ...
                   :title="dialogTitle"
                   @dragDialog="handleDrag">
            <img v-if="showWindows.type==='image'"
                 :src="showWindows.url"
                 alt=""

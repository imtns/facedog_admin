<template>
  <div class="app-container">
    <el-col :span="18" :offset="6">
      <el-col :span="12">
        <el-col>
          <img class="img-circle" :src="details.avatar">
      ...
      <el-col :span="18" style="padding-top: 30px">
        <img v-for="(like, index) of details.likes" v-if="index<10" class="img-circle" @click="userDetails(like.user_id)" :src="like.avatar" alt="" style="height:30px;width:30px">
